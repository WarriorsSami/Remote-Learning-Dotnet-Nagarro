...
namespace iQuest.HotelQueries.DataAccess.CsvModel
{
    internal class CustomerCsvRecord
    {
        ...
        public static string Header =>
            "id,first_name,last_name,email,gender,city,Country,Phone,LastAccommodation";
        ...
        public CustomerCsvRecord(Customer customer)
        {
            ...
            lastAccommodation = customer.LastAccommodation.ToString(
                "M/d/yyyy",
        ...
        {
            return isPerson ? (Customer)CreatePersonCustomer() : CreateCompanyCustomer();
        }
